...
## <a name="Lecture4b"></a> Lecture4b  Logic

##  <a name="Lecturex3b"></a> Lecture 3b Learning
### Learning agents
- Performance element + Learning element

#### Performance element
- Selecting action base on percepts.
- Corresponds to the previous agent programs.

#### Learning element
- Introduce improvements in performance element
- <ins>Critic</ins> provides feedback on agents performance based on fixed performance standard.
- Design is effected by:
	- Which components of the performance element are to be learned
	- What feedback is available te learn these components
		- Type of feedback:
			- Supervised learning
			- Unsupervised learning
			- Reinforcement learning
...
- A decision tree is a tree where:
	...
	- Each leaf noce is labelled with a class (class node)

#### When to consider decision trees?
- Each instance consists of an attribute with discrete values.
- The classification is over discrete values. (yes/no)
- It is okay for the training data to contain errors.
- It is okay for the training data to contain missing values.

### Entropy
**Let **<br>
- S be a sample of training examples
- p+ is the proportion of positive examples in S
- p- is the proportion of negative examples in S
**Then **<br>
- Entropy measures the <ins>impurity</ins> of S:
	- E(S) = -(P+)(log2p+) - (p-)(log2p-)

#### Entropy with n classes
- So for 2 classes we have: E(S) = -(P+)(log2p+) - (p-)(log2p-)
...
- But now if we have 5, 3 and 2 in each class we will get:
	- (-0.5)(log2 0.5) - (0.3)(log2 0.3) - (0.2)(log2 0.2) = 1.49
- This breaks the idea that entropy is between 0 and 1.
- To fix this, we use log3 for 3 classen and logn for n classes.

### Information gain 
- Is the expected reduction in entropy caused by partitioning the instances form S according to a given attribute.
- Gain (S, A) = E(S) - SUMvinA((|Sc|/|S|)*E(Sv))
- Where Sv = {s in S | A(s) = V}
